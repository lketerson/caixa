...
_1671: v => stringToDartString(v.toString()),
_1672: (d, digits) => stringToDartString(d.toFixed(digits)),
_1676: o => new WeakRef(o),
_1677: r => r.deref(),
_1682: Date.now,
...
_1696: s => printToConsole(stringFromDartString(s)),
...
_1765: a => a.length,
_1766: (a, l) => a.length = l,
_1767: (a, i) => a[i],
_1768: (a, i, v) => a[i] = v,
_1770: a => a.join(''),
_1771: (o, a, b) => o.replace(a, b),
_1773: (s, t) => s.split(t),
...
_1824: (x0,x1) => x0.getRandomValues(x1),
_1825: x0 => new Uint8Array(x0),
_1826: () => globalThis.crypto,
...
_2002: (x0,x1) => x0.withCredentials = x1,
_2004: x0 => x0.responseURL,
_2005: x0 => x0.status,
_2006: x0 => x0.statusText,
_2008: (x0,x1) => x0.responseType = x1,
_2009: x0 => x0.response,
_3825: () => globalThis.window,
_3885: x0 => x0.location,
